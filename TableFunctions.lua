...
local function RightClickMenu(self)
		...
		{ text = L["TABLEVIEWS"], notCheckable = true, hasArrow = true,
				menuList = { 
					{ text = L["VIEWRAID"], notCheckable = true, keepShownOnClick = false; func = function()
						...
						MonDKP.ConfigTab1.checkBtn[11]:SetChecked(true);
						ToggleDropDownMenu(nil, nil, menuFrame)
					end },
	...
	menu[7].menuList[#core.classes+2] = { text = L["ONLYPARTYRAID"], isNotRadio = true, keepShownOnClick = false, disabled = not IsInRaid(), checked = MonDKP.ConfigTab1.checkBtn[11]:GetChecked(), func = function()
	...
	menu[7].menuList[#core.classes+3] = { text = L["ONLINE"], isNotRadio = true, keepShownOnClick = true, checked = MonDKP.ConfigTab1.checkBtn[12]:GetChecked(), func = function()
	...
	menu[7].menuList[#core.classes+4] = { text = L["NOTINRAIDFILTER"], isNotRadio = true, keepShownOnClick = false, disabled = not IsInRaid(), checked = MonDKP.ConfigTab1.checkBtn[13]:GetChecked(), func = function()
		MonDKP.ConfigTab1.checkBtn[13]:SetChecked(not MonDKP.ConfigTab1.checkBtn[13]:GetChecked())
		MonDKP.ConfigTab1.checkBtn[11]:SetChecked(false)
		menu[7].menuList[#core.classes+2].checked = false

		MonDKPFilterChecks(MonDKP.ConfigTab1.checkBtn[13])
		if UIDROPDOWNMENU_OPEN_MENU then
			ToggleDropDownMenu(nil, nil, menuFrame)
		end
	end }
...
function MonDKP:DKPTable_Create()
	MonDKP.DKPTable = CreateFrame("ScrollFrame", "MonDKPDisplayScrollFrame", MonDKP.UIConfig, "BackdropTemplate,FauxScrollFrameTemplate")
