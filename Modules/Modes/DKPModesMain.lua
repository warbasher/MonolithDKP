...
function MonDKP:DKPModes_Main()
	...
	f.DKPModesMain.ModesDropDown  = LibDD:Create_UIDropDownMenu("MonDKPModeSelectDropDown", f.DKPModesMain)
	...
	f.DKPModesMain.RoundDropDown = LibDD:Create_UIDropDownMenu("MonDKPModeSelectDropDown", f.DKPModesMain)
	...
	LibDD:UIDropDownMenu_SetText(f.DKPModesMain.RoundDropDown, MonDKP_DB.modes.rounding)
	...
	-- AntiSnipe Option
	f.DKPModesMain.AntiSnipe = CreateFrame("EditBox", nil, f.DKPModesMain, "BackdropTemplate")
	...
	f.DKPModesMain.ChannelsDropDown = LibDD:Create_UIDropDownMenu("MonDKPModeSelectDropDown", f.DKPModesMain)
	...
	f.DKPModesMain.CostSelection = LibDD:Create_UIDropDownMenu("MonDKPModeSelectDropDown", f.DKPModesMain)
	...
	f.DKPModesMain.Inflation = CreateFrame("EditBox", nil, f.DKPModesMain, "BackdropTemplate")
	...
	f.DKPModesMain.ZeroSumType = LibDD:Create_UIDropDownMenu("MonDKPModeSelectDropDown", f.DKPModesMain)
	...
	LibDD:UIDropDownMenu_SetText(f.DKPModesMain.ZeroSumType, MonDKP_DB.modes.ZeroSumBidType)
	...
	f.DKPModesMain.ItemCostDropDown = LibDD:Create_UIDropDownMenu("MonDKPModeSelectDropDown", f.DKPModesMain)

	-- Create and bind the initialization function to the dropdown menu
	LibDD:UIDropDownMenu_Initialize(f.DKPModesMain.ItemCostDropDown, function(self, level, menuList)
	...
	LibDD:UIDropDownMenu_SetText(f.DKPModesMain.ItemCostDropDown, L[MonDKP_DB.modes.costvalue])
	...
	function f.DKPModesMain.ItemCostDropDown:SetValue(arg1)
		...
		LibDD:UIDropDownMenu_SetText(f.DKPModesMain.ItemCostDropDown, L[arg1])
		LibDD:CloseDropDownMenus()
	end
	...
	f.DKPModesMain.MaxBid = CreateFrame("EditBox", nil, f.DKPModesMain, "BackdropTemplate")
	...
	-- Roll Container
	f.DKPModesMain.RollContainer = CreateFrame("Frame", nil, f.DKPModesMain, "BackdropTemplate");
    ...
    f.DKPModesMain.RollContainer.Header:SetText(L["ROLLSETTINGS"])
		...
		-- Min Roll Editbox
		f.DKPModesMain.RollContainer.rollMin = CreateFrame("EditBox", nil, f.DKPModesMain.RollContainer, "BackdropTemplate")
	    ...
	    -- Max Roll Editbox
		f.DKPModesMain.RollContainer.rollMax = CreateFrame("EditBox", nil, f.DKPModesMain.RollContainer, "BackdropTemplate")
    	...
    	-- Add to Max Editbox
		f.DKPModesMain.RollContainer.AddMax = CreateFrame("EditBox", nil, f.DKPModesMain.RollContainer, "BackdropTemplate")
