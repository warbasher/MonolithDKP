...
function MonDKP:ZeroSumBank_Create()
	local f = CreateFrame("Frame", "MonDKP_DKPZeroSumBankFrame", UIParent, "BackdropTemplate,ShadowOverlaySmallTemplate");
	...
	-- Close Button
	f.closeContainer = CreateFrame("Frame", "MonDKPZeroSumBankWindowCloseButtonContainer", f, "BackdropTemplate")
	...
	f.Balance = CreateFrame("EditBox", nil, f, "BackdropTemplate")
	...
	-- Loot List Frame
	f.LootFrame = CreateFrame("Frame", "MonDKPZeroSumBankLootListContainer", f, "BackdropTemplate,ShadowOverlaySmallTemplate")
