...
function MonDKPFilterChecks(self)         -- sets/unsets check boxes in conjunction with "All" button, then runs MonDKP:FilterDKPTable() above
	...
	if (self:GetChecked() == false and not MonDKP.ConfigTab1.checkBtn[11]) then
...
function MonDKP:ConfigMenuTabs()
	...
	MonDKP.UIConfig.TabMenu = CreateFrame("Frame", "MonDKPMonDKP.ConfigTabMenu", MonDKP.UIConfig, "BackdropTemplate")
	MonDKP.UIConfig.TabMenu:SetPoint("TOPRIGHT", MonDKP.UIConfig, "TOPRIGHT", -25, -25)
	MonDKP.UIConfig.TabMenu:SetSize(477, 510)
	--MonDKP.UIConfig.TabMenu:SetSize(535, 510)
	...
	--MonDKP.ConfigTab1, MonDKP.ConfigTab2, MonDKP.ConfigTab3, MonDKP.ConfigTab4, MonDKP.ConfigTab5, MonDKP.ConfigTab6, MonDKP.ConfigTab7 = MonDKP:SetTabs(MonDKP.UIConfig.TabMenu, 7, 475, 490, L["FILTERS"], L["ADJUSTDKP"], L["MANAGE"], L["OPTIONS"], L["LOOTHISTORY"], L["DKPHISTORY"], "Items")
	...
	for i=1, 11 do
		...
		if i <= 10 then MonDKP.ConfigTab1.checkBtn[i]:SetChecked(true) else MonDKP.ConfigTab1.checkBtn[i]:SetChecked(false) end
	...
	-- Class Check Buttons:
	MonDKP.ConfigTab1.checkBtn[1]:SetPoint("TOPLEFT", MonDKP.ConfigTab1, "TOPLEFT", 40, -70);
	...
	MonDKP.ConfigTab1.checkBtn[5]:SetPoint("TOPLEFT", MonDKP.ConfigTab1.checkBtn[4], "TOPRIGHT", 50, 0);
	MonDKP.ConfigTab1.checkBtn[6]:SetPoint("TOPLEFT", MonDKP.ConfigTab1.checkBtn[1], "BOTTOMLEFT", 0, -10);
	MonDKP.ConfigTab1.checkBtn[7]:SetPoint("TOPLEFT", MonDKP.ConfigTab1.checkBtn[2], "BOTTOMLEFT", 0, -10);
	MonDKP.ConfigTab1.checkBtn[8]:SetPoint("TOPLEFT", MonDKP.ConfigTab1.checkBtn[3], "BOTTOMLEFT", 0, -10);
	MonDKP.ConfigTab1.checkBtn[9]:SetPoint("TOPLEFT", MonDKP.ConfigTab1.checkBtn[4], "BOTTOMLEFT", 0, -10);

	MonDKP.ConfigTab1.checkBtn[10]:SetPoint("BOTTOMRIGHT", MonDKP.ConfigTab1.checkBtn[3], "TOPLEFT", 50, 0);
	MonDKP.ConfigTab1.checkBtn[10].text:SetText("|cff5151de"..L["ALLCLASSES"].."|r");
	MonDKP.ConfigTab1.checkBtn[11]:SetPoint("TOPLEFT", MonDKP.ConfigTab1.checkBtn[6], "BOTTOMLEFT", 50, 0);
	MonDKP.ConfigTab1.checkBtn[11].text:SetText("|cff5151de"..L["INPARTYRAID"].."|r");         -- executed in filterDKPTable (CommunityDKP.lua)
	...
	MonDKP.ConfigTab1.checkBtn[12].text:SetText("|cff5151de"..L["ONLINE"].."|r");
	MonDKP.ConfigTab1.checkBtn[12].text:SetFontObject("MonDKPSmall")
	MonDKP.ConfigTab1.checkBtn[12]:SetScript("OnClick", MonDKPFilterChecks)
	MonDKP.ConfigTab1.checkBtn[12]:SetPoint("TOPLEFT", MonDKP.ConfigTab1.checkBtn[11], "TOPRIGHT", 100, 0);

	MonDKP.ConfigTab1.checkBtn[13] = CreateFrame("CheckButton", nil, MonDKP.ConfigTab1, "UICheckButtonTemplate");
	MonDKP.ConfigTab1.checkBtn[13]:SetID(13)
	MonDKP.ConfigTab1.checkBtn[13].text:SetText("|cff5151de"..L["NOTINRAIDFILTER"].."|r");
	MonDKP.ConfigTab1.checkBtn[13].text:SetFontObject("MonDKPSmall")
	MonDKP.ConfigTab1.checkBtn[13]:SetScript("OnClick", function(self)
		MonDKP.ConfigTab1.checkBtn[13]:SetChecked(false);
		MonDKPFilterChecks(self)
	end)
	MonDKP.ConfigTab1.checkBtn[13]:SetPoint("TOPLEFT", MonDKP.ConfigTab1.checkBtn[12], "TOPRIGHT", 65, 0);
	...
	--[[MonDKP.ConfigTab7.text = MonDKP.ConfigTab7:CreateFontString(nil, "OVERLAY")
	MonDKP.ConfigTab7.text:ClearAllPoints()
	MonDKP.ConfigTab7.text:SetFontObject("MonDKPLargeLeft")
	MonDKP.ConfigTab7.text:SetPoint("TOPLEFT", MonDKP.ConfigTab7, "TOPLEFT", 15, -10)
	MonDKP.ConfigTab7.text:SetText("Items")
	MonDKP.ConfigTab7.text:SetScale(1.2)

	MonDKP.ConfigTab7.inst = MonDKP.ConfigTab7:CreateFontString(nil, "OVERLAY")
	MonDKP.ConfigTab7.inst:ClearAllPoints()
	MonDKP.ConfigTab7.inst:SetFontObject("MonDKPSmallRight")
	MonDKP.ConfigTab7.inst:SetTextColor(0.3, 0.3, 0.3, 0.7)
	MonDKP.ConfigTab7.inst:SetPoint("TOPRIGHT", MonDKP.ConfigTab7, "TOPRIGHT", -40, -43)
	
	local looter = {}
	local lootFrame = {}
	MonDKP.ConfigTab7.looter = looter
	MonDKP.ConfigTab7.lootFrame = lootFrame

	for i=1, #MonDKP_Loot do
		MonDKP.ConfigTab7.lootFrame[i] = CreateFrame("Frame", "MonDKPItemHistoryFrame"..i, MonDKP.ConfigTab7)
	end

	-- Update the history
	if (#MonDKP_Loot > 0) then
		MonDKP:ItemHistory_Update(L["NOFILTER"])
		CreateSortBox()
	end]]
end
